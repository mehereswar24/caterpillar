"""
train_maintenance.py — LightGBM maintenance predictor.
Predicts hours_until_service from machine telemetry.
Saves: maintenance_model.joblib + maintenance_feature_cols.json
"""
...
# Derive hours_until_service from engine hours (service every 500h)
...
FEATURES = [
    "engine_hours","rpm","hydraulic_pressure","temperature_c",
...
print(json.dumps({"model":"LightGBM_Maintenance","mae_hours":round(mae,2),"rmse_hours":round(rmse,2),"n_features":len(FEATURES)}))
