  ...
  const items = [
    {
      ...
      colorClass: isRpmAbnormal ? 'text-red-600' : 'text-neutral-900',
    ...
    },
    {
      ...
      colorClass: isHydAbnormal ? 'text-amber-600' : 'text-neutral-900',
    ...
    },
    {
      ...
      value: `${fuelPct}%`,
      abnormal: isFuelLow,
      colorClass: isFuelLow ? 'text-red-600 font-bold' : 'text-neutral-900',
    ...
    },
    {
      ...
      value: `${engineTempC}°C`,
      abnormal: isTempHigh,
      colorClass: isTempHigh ? 'text-red-600' : 'text-neutral-900',
    ...
    },
    {
      ...
      abnormal: isTiltHigh,
      colorClass: isTiltHigh ? 'text-red-600 font-bold' : 'text-neutral-900',
      dotClass: isTiltHigh ? 'bg-red-500 animate-pulse' : 'bg-emerald-400',
    },
  ];

  return (
    <div className="bg-[#ffffff] border border-[#e6e6e1] rounded-2xl px-3 py-2">
      <div className="grid grid-cols-5 divide-x divide-[#e6e6e1] text-center">
        {items.map((item, idx) => (
